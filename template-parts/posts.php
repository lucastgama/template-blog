...
<section class="container__ee container__posts" id="posts">
    ...
    <div class="container__category">
        ...
        ?>
        <form method="get" action="<?php echo esc_url(home_url('/')); ?>" class="flex gap-4">
            <input
                type="text"
                id="search-input"
                placeholder="Pesquisar..."
                class="search-input focus:outline-none border rounded-full px-4 py-2 text-sm w-full dark:bg-gray-800 dark:text-white"
                value="<?php echo get_search_query(); ?>">
            <button
                type="submit"
                class="search-button bg-sky-600 text-white px-4 py-2 rounded-full text-sm font-medium dark:bg-sky-500 hover:bg-sky-700">
                Buscar
            </button>
        </form>
    </div>
