<section class="container__rules" id="rules">
    ...
    <div class="rules__cards">
        <div class="rules__card">
            ...
            <h4>Comentarios</h4>
            <p>
                Comentarios riduclos, menospresando alguem ou algum estagiario será
                removido, caso queira fazer algo desse tipo vá para o stackoverflow
            </p>
        </div>
        <div class="rules__card">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/StayAnonymous.png" alt="" />
            <h4>Privacidade</h4>
            <p>
                Nada de expor a vida de ninguém nos comentários! Guarde a fofoca para você.
            </p>
        </div>
        <div class="rules__card">
